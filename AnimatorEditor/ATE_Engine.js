function ATE_Engine() {
    ...
    this.Initialize = function(selectorName) {
        ...
        mSelf.AddLayer("x", 0, 0);
        mSelf.AddLayer("x", 0.3, 65);
        mSelf.AddLayer("x", 0.5, 100);
        mSelf.AddLayer("x", 0.7, 180);
        mSelf.AddLayer("x", 0.8, 205);
        mSelf.AddLayer("x", 2, 230);
        
        mSelf.AddLayer("y", 0.3, 240);
        mSelf.AddLayer("y", 1, 400);
        mSelf.AddLayer("y", 1.5, 700);
        
        mSelf.AddLayer("a", 0, 0);
        mSelf.AddLayer("b", 0, 0);
        mSelf.AddLayer("c", 0, 0);
        mSelf.AddLayer("d", 0, 0);
        mSelf.AddLayer("e", 0, 0);
        mSelf.AddLayer("f", 0, 0);
        mSelf.AddLayer("g", 0, 0);
        mSelf.AddLayer("g1", 0, 0);
        mSelf.AddLayer("g2", 0, 0);
        mSelf.AddLayer("g3", 0, 0);
...
function ATE_Styles() {}
ATE_Styles.Default_Seconds = 3;
ATE_Styles.Default_SubSegments = 10;

ATE_Styles.CanvasHeight = 300;
